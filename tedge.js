...
function onKeyDown(evt) 
{
	...
	else if (evt.keyCode == 83) K_DOWN = true;
	else if (evt.keyCode == 68) K_RIGHT = true;
	else if (evt.keyCode == 87) K_UP = true;
	else if (evt.keyCode == 65) K_LEFT = true;
...
function onKeyUp(evt) 
{
	...
	else if (evt.keyCode == 83) K_DOWN = false;
	else if (evt.keyCode == 68) K_RIGHT = false;
	else if (evt.keyCode == 87) K_UP = false;
	else if (evt.keyCode == 65) K_LEFT = false;
}
